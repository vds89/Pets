...
// Get readable database
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        // No need to check the breed. Any value is allowed, also null
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int mRowsUpdated = db.update(
                PetContract.PetEntry.TABLE_NAME,    // the table name to update
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                ...
                mRowsDeleted = database.delete(PetContract.PetEntry.TABLE_NAME, selection, selectionArgs);
                return mRowsDeleted;
            case PET_ID:
